  ...
  const fetchAgreement = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        setSigned(response.data.agreement.student_signed || false);
      }
    } catch (error) {
...
const handleSignAgreement = async () => {
  console.log('🔵 handleSignAgreement called');
  ...
  try {
    ...
    if (response.data.success) {
      ...
      const updatedAgreement = updatedResponse.data.agreement;
      
      // ✅ التحقق مما إذا كانت جميع الأطراف قد وقعوا
      if (updatedAgreement.student_signed === 1 && 
          updatedAgreement.company_signed === 1 && 
          updatedAgreement.university_signed === 1) {
        ...
        toast.success('🎉 Agreement fully completed! All parties have signed.');
      }
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-8 py-6">
            <h1 className="text-2xl font-bold text-white">Sign Agreement</h1>
            <p className="text-green-100 mt-2">Please review and sign your internship agreement</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="border-t pt-8">
              ...
              {/* Save Signature Button - This is what you're missing! */}
              {!signature && (
                <button
              ...
              {signature && (
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-500 mb-2">Your Signature Preview:</p>
                  <img 
                    src={signature} 
                    alt="Signature" 
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-green-600 text-white py-4 rounded-xl hover:bg-green-700 font-medium disabled:opacity-50"
                >
