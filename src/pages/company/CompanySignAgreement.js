...
const CompanySignAgreement = () => {
  ...
  const fetchAgreement = async () => {
    try {
      ...
      if (response.data.success) {
        ...
        setSigned(response.data.agreement.company_signed || false);
      }
    } catch (error) {
  ...
  const saveSignature = () => {
    console.log('📝 Company saveSignature called');
  ...
  const handleSignAgreement = async () => {
    console.log('🔵 Company handleSignAgreement called');
    console.log('signature exists?', signature ? 'YES' : 'NO');
    
    if (!signature) {
      toast.error('Please add your company signature first');
      return;
    }
    ...
    try {
      ...
      if (response.data.success) {
        setSigned(true);
        toast.success('✅ Company agreement signed successfully!');
        setTimeout(() => {
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Your company has already signed this agreement.
            </p>
            <button
              onClick={() => navigate('/company/agreements')}
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-6">
            <h1 className="text-2xl font-bold text-white">Sign Agreement as Company</h1>
            <p className="text-blue-100 mt-2">Please review and sign the internship agreement</p>
          </div>
          ...
          <div className="p-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-gray-600">📅 {formatDate(agreement.start_date)} - {formatDate(agreement.end_date)}</div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3 text-gray-600 text-sm">
                <p>1. The student agrees to complete the internship period as specified.</p>
                <p>2. The company agrees to provide necessary training and supervision.</p>
                <p>3. Both parties agree to maintain confidentiality.</p>
                <p>4. The student will receive a stipend of {agreement.stipend} DZD/month.</p>
              </div>
            </div>

            {/* Signature Section */}
            <div className="border-t pt-8">
              <h3 className="font-semibold text-gray-900 mb-4">Company Digital Signature</h3>
              ...
              {signatureType === 'type' && (
                <div className="mb-6">
                  <input
                    ...
                    placeholder="Type company representative name as signature"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg"
                  />
                  <p className="text-sm text-gray-500 mt-2">
                    By typing your name, you agree to the terms and conditions above.
                  </p>
                </div>
              )}
              ...
              {signature && (
                <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm text-gray-500 mb-2">Company Signature Preview:</p>
                  <img 
                    src={signature} 
              ...
              <div className="flex gap-4">
                <button
                  ...
                  className="flex-1 bg-blue-600 text-white py-4 rounded-xl hover:bg-blue-700 font-medium disabled:opacity-50"
                >
                  {signing ? 'Signing...' : 'Sign Agreement as Company'}
                </button>
                <button
                  onClick={() => navigate('/company/agreements')}
...
export default CompanySignAgreement;